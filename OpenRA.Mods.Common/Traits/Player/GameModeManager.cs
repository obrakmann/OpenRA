...
namespace OpenRA.Mods.Common.Traits
{
	...
	class GameModeManagerInfo : ITraitInfo, ILobbyOptions, IEditorActorOptions, Requires<ConditionManagerInfo>, Requires<GameModeInfo>
	{
		...
		IEnumerable<EditorActorOption> IEditorActorOptions.ActorOptions(ActorInfo ai, World world)
		{
			...
			(actor) =>
			{
				...
				var init = actor.Init<GameModesInit>();
				var mode = init != null ? init.Value(world).First() : "";
				return mode;
			},
			(actor, value) =>
			{
